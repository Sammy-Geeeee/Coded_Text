...
class FrameMain(tk.Frame):
    def __init__(self, master):
        ...
        self.button_de_copy = tk.Button(master=self.frame_decrypted, command=self.de_copy_text, text='Copy', width=button_width)
        self.button_de_paste = tk.Button(master=self.frame_decrypted, command=self.de_paste_text, text='Paste', width=button_width)
        # Positions all the widgets
        ...
        self.button_encrypt = tk.Button(master=self.frame_buttons, command=self.encrypt_apply, text='Encrypt', width=button_width)
        self.button_decrypt = tk.Button(master=self.frame_buttons, command=self.decrypt_apply, text='Decrypt', width=button_width)
        ...
        self.button_en_copy = tk.Button(master=self.frame_encrypted, command=self.en_copy_text, text='Copy', width=button_width)
        self.button_en_paste = tk.Button(master=self.frame_encrypted, command=self.en_paste_text, text='Paste', width=button_width)
        # Positions all the widgets
